...
const Background2 = () => {
  const background = useStaticQuery(graphql`
    query {
      image_1920_width: file(relativePath: { eq: "background3.jpg" }) {
        childImageSharp {
      ...
      image_1500_width: file(relativePath: { eq: "background3.jpg" }) {
        childImageSharp {
      ...
      image_1080_width: file(relativePath: { eq: "background3.jpg" }) {
        childImageSharp {
      ...
      image_768_width: file(relativePath: { eq: "background3.jpg" }) {
        childImageSharp {
